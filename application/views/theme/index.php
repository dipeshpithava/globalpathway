...
<html>
    <head>
        ...
        <!-- Base Css Files -->
        <link href="<?=base_url()?>assets/libs/jqueryui/ui-lightness/jquery-ui-1.10.4.custom.min.css" rel="stylesheet" />
        ...
        <link href="<?=base_url()?>assets/libs/fontello/css/fontello.css" rel="stylesheet" />
        <link href="<?=base_url()?>assets/libs/animate-css/animate.min.css" rel="stylesheet" />
        <link href="<?=base_url()?>assets/libs/nifty-modal/css/component.css" rel="stylesheet" />
        <link href="<?=base_url()?>assets/libs/magnific-popup/magnific-popup.css" rel="stylesheet" /> 
        <link href="<?=base_url()?>assets/libs/ios7-switch/ios7-switch.css" rel="stylesheet" /> 
        <link href="<?=base_url()?>assets/libs/pace/pace.css" rel="stylesheet" />
        <link href="<?=base_url()?>assets/libs/sortable/sortable-theme-bootstrap.css" rel="stylesheet" />
        <link href="<?=base_url()?>assets/libs/bootstrap-datepicker/css/datepicker.css" rel="stylesheet" />
        <link href="<?=base_url()?>assets/libs/jquery-icheck/skins/all.css" rel="stylesheet" />
        <!-- Code Highlighter for Demo -->
        <link href="<?=base_url()?>assets/libs/prettify/github.css" rel="stylesheet" />
        
                <!-- Extra CSS Libraries Start -->
                <link href="<?=base_url()?>assets/libs/rickshaw/rickshaw.min.css" rel="stylesheet" type="text/css" />
                <link href="<?=base_url()?>assets/libs/morrischart/morris.css" rel="stylesheet" type="text/css" />
                <link href="<?=base_url()?>assets/libs/jquery-jvectormap/css/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
                <link href="<?=base_url()?>assets/libs/jquery-clock/clock.css" rel="stylesheet" type="text/css" />
                <link href="<?=base_url()?>assets/libs/bootstrap-calendar/css/bic_calendar.css" rel="stylesheet" type="text/css" />
                <link href="<?=base_url()?>assets/libs/sortable/sortable-theme-bootstrap.css" rel="stylesheet" type="text/css" />
                <link href="<?=base_url()?>assets/libs/jquery-weather/simpleweather.css" rel="stylesheet" type="text/css" />
                <link href="<?=base_url()?>assets/libs/bootstrap-xeditable/css/bootstrap-editable.css" rel="stylesheet" type="text/css" />
                        ...
                        <ul class="dropdown-menu dropdown-message">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="<?=base_url()?>images/users/chat/2.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="<?=base_url()?>images/users/chat/1.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <img src="<?=base_url()?>images/users/chat/3.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
...
<!-- Top Bar End -->
            ...
            <div class="sidebar-inner slimscrollleft">
               <!-- Search form -->
                ...
                <div class="profile-info">
                    <div class="col-xs-4">
                      <a href="profile.html" class="rounded-image profile-image"><img src="<?=base_url()?>images/users/user-100.jpg"></a>
                    </div>
                    <div class="col-xs-8">
                ...
                <!--- Divider -->
                <div id="sidebar-menu">
                    <ul><li><a href='index.html' class='active'><i class='icon-home-3'></i><span>Dashboard</span></a></li><li class='has_sub'><a href='#'><i class='icon-feather'></i><span>UI Elements</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='alerts.html'><span>Alerts</span></a></li><li><a href='buttons.html'><span>Buttons</span></a></li><li><a href='calendar.html'><span>Calendar</span></a></li><li><a href='grid.html'><span>Grid</span></a></li><li><a href='icons.html'><span>Icons</span></a></li><li><a href='modals.html'><span>Modals</span></a></li><li><a href='nested-list.html'><span>Nested List</span></a></li><li><a href='notifications.html'><span>Notifications</span></a></li><li><a href='portlets.html'><span>Portlets</span></a></li><li><a href='progress-bars.html'><span>Progress Bars</span></a></li><li><a href='tabs-accordions.html'><span>Tabs & Accordions</span></a></li><li><a href='typography.html'><span>Typography</span></a></li></ul></li><li class='has_sub'><a href='#'><i class='icon-pencil-3'></i><span>Forms</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='forms.html'><span>Form Elements</span></a></li><li><a href='advanced-forms.html'><span>Advanced Forms</span></a></li><li><a href='form-wizard.html'><span>Form Wizard</span></a></li><li><a href='form-validation.html'><span>Form Validation</span></a></li><li><a href='form-uploads.html'><span>File Uploads</span></a></li></ul></li><li class='has_sub'><a href='#'><i class='fa fa-table'></i><span>Tables</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='tables.html'><span>Basic Tables</span></a></li><li><a href='datatables.html'><span>Datatables</span></a></li></ul></li><li class='has_sub'><a href='#'><i class='fa fa-map-marker'></i><span>Maps</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='google-maps.html'><span>Google Maps</span></a></li><li><a href='vector-maps.html'><span>Vector Maps</span></a></li></ul></li><li class='has_sub'><a href='#'><i class='fa fa-envelope'></i><span>Email</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='inbox.html'><span>Inbox</span></a></li><li><a href='read-message.html'><span>View Email</span></a></li><li><a href='new-message.html'><span>New Message</span></a></li></ul></li><li class='has_sub'><a href='#'><i class='icon-chart-line'></i><span>Charts</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='sparkline-charts.html'><span>Sparkline Charts</span></a></li><li><a href='morris-charts.html'><span>Morris Charts</span></a></li><li><a href='rickshaw-charts.html'><span>Rickshaw Charts</span></a></li><li><a href='other-charts.html'><span>Other Charts</span></a></li></ul></li><li class='has_sub'><a href='#'><i class='icon-megaphone'></i><span>Extras</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='blank.html'><span>Blank Page</span></a></li><li><a href='login.html'><span>Login</span></a></li><li><a href='register.html'><span>Register</span></a></li><li><a href='lockscreen.html'><span>Lock Screen</span></a></li><li><a href='404.html'><span>404 Error</span></a></li><li><a href='500.html'><span>500 Error</span></a></li><li><a href='profile.html'><span>User Profile</span></a></li><li><a href='invoice.html'><span>Invoice</span></a></li><li><a href='gallery.html'><span>Gallery</span></a></li><li><a href='maintenance.html'><span>Maintenance</span></a></li><li class='has_sub'><a href='#'><span>3 Level menu</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='#'><span>Sub Item</span></a></li></ul></li><li class='has_sub'><a href='#'><span>4 Level Menu</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li class='has_sub'><a href='#'><span>Sub Item - level 3</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='#'><span>Sub Item - level 4</span></a></li></ul></li></ul></li><li class='has_sub'><a href='#'><span>Submenu with icons</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a><ul><li><a href='#'><i class='fa fa-camera'></i><span>Item with icon</span></a></li><li><a href='#'><i class='entypo entypo-users'></i><span>Another Item</span></a></li></ul></li></ul></li></ul>                    <div class="clearfix"></div>
                </div>
            <div class="clearfix"></div>
            <div class="portlets">
					    ...
					    <div id="chat-coll" class="panel-collapse collapse in">
					      <div class="panel-body">
					      	<ul class="list-unstyled" id="chat-list">
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/1.jpg"></span> <span class="chat-user-name">Dorothy Simons</span><span class="chat-user-msg">I wish I was a bird in the sky</span></a></li>
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/2.jpg"></span> <span class="chat-user-name">John Malkovich</span><span class="chat-user-msg">You were the traitor</span></a></li>
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/3.jpg"></span> <span class="chat-user-name">Jessica Simons</span><span class="chat-user-msg">Where is my mind</span></a></li>
					      		<li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/4.jpg"></span> <span class="chat-user-name">Jack Stallman</span><span class="chat-user-msg">Away since 13:32</span></a></li>
					      		<li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/5.jpg"></span> <span class="chat-user-name">Neil Armstrong</span><span class="chat-user-msg" title="I am flying to the moon and back">I am flying to the moon and back</span></a></li>
					      		<li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/6.jpg"></span> <span class="chat-user-name">Hollywood Studios</span><span class="chat-user-msg">Yes he definitely is!</span></a></li>
					      	</ul>
					      </div>
					    </div>
					  </div>
					    ...
					    <div id="collapseTwo" class="panel-collapse collapse in">
					      <div class="panel-body">
					      	<ul class="list-unstyled" id="chat-list">
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/1.jpg"></span> <span class="chat-user-name">Dorothy Simons</span><span class="chat-user-msg">I wish I was a bird in the sky</span></a></li>
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/2.jpg"></span> <span class="chat-user-name">John Malkovich</span><span class="chat-user-msg">You were the traitor</span></a></li>
					      		<li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/3.jpg"></span> <span class="chat-user-name">Jessica Simons</span><span class="chat-user-msg" title="Eminem - The Monster ft. Rihanna"><i class="icon-play"></i> Eminem - The Monster ft. Rihanna</span></a></li>
					      		<li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/4.jpg"></span> <span class="chat-user-name">Jack Stallman</span><span class="chat-user-msg">Away since 13:32</span></a></li>
					      		<li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/5.jpg"></span> <span class="chat-user-name">Neil Armstrong</span><span class="chat-user-msg" title="I am flying to the moon and back">I am flying to the moon and back</span></a></li>
					      		<li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="<?=base_url()?>images/users/chat/6.jpg"></span> <span class="chat-user-name">Hollywood Studios</span><span class="chat-user-msg">Yes he definitely is!</span></a></li>
					      	</ul>
	...
	<script src="<?=base_url()?>assets/libs/jquery/jquery-1.11.1.min.js"></script>
	<script src="<?=base_url()?>assets/libs/bootstrap/js/bootstrap.min.js"></script>
	<script src="<?=base_url()?>assets/libs/jqueryui/jquery-ui-1.10.4.custom.min.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-ui-touch/jquery.ui.touch-punch.min.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-detectmobile/detect.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-animate-numbers/jquery.animateNumbers.js"></script>
	<script src="<?=base_url()?>assets/libs/ios7-switch/ios7.switch.js"></script>
	<script src="<?=base_url()?>assets/libs/fastclick/fastclick.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-blockui/jquery.blockUI.js"></script>
	<script src="<?=base_url()?>assets/libs/bootstrap-bootbox/bootbox.min.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-slimscroll/jquery.slimscroll.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-sparkline/jquery-sparkline.js"></script>
	<script src="<?=base_url()?>assets/libs/nifty-modal/js/classie.js"></script>
	<script src="<?=base_url()?>assets/libs/nifty-modal/js/modalEffects.js"></script>
	<script src="<?=base_url()?>assets/libs/sortable/sortable.min.js"></script>
	<script src="<?=base_url()?>assets/libs/bootstrap-fileinput/bootstrap.file-input.js"></script>
	...
	<script src="<?=base_url()?>assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-icheck/icheck.min.js"></script>

	<!-- Demo Specific JS Libraries -->
	<script src="<?=base_url()?>assets/libs/prettify/prettify.js"></script>

	<script src="<?=base_url()?>assets/js/init.js"></script>
	<!-- Page Specific JS Libraries -->
	<script src="<?=base_url()?>assets/libs/d3/d3.v3.js"></script>
	<script src="<?=base_url()?>assets/libs/rickshaw/rickshaw.min.js"></script>
	<script src="<?=base_url()?>assets/libs/raphael/raphael-min.js"></script>
	<script src="<?=base_url()?>assets/libs/morrischart/morris.min.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-knob/jquery.knob.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-jvectormap/js/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-jvectormap/js/jquery-jvectormap-us-aea-en.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-clock/clock.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-easypiechart/jquery.easypiechart.min.js"></script>
	<script src="<?=base_url()?>assets/libs/jquery-weather/jquery.simpleWeather-2.6.min.js"></script>
	<script src="<?=base_url()?>assets/libs/bootstrap-xeditable/js/bootstrap-editable.min.js"></script>
	<script src="<?=base_url()?>assets/libs/bootstrap-calendar/js/bic_calendar.min.js"></script>
	<script src="<?=base_url()?>assets/js/apps/calculator.js"></script>
	<script src="<?=base_url()?>assets/js/apps/todo.js"></script>
